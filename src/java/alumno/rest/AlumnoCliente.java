...
/**
 * Jersey REST client generated for REST resource:TbAlumnoFacadeREST
 * [modelo.tbalumno]<br>
 * USAGE:
 * <pre>
 *        AlumnoCliente client = new AlumnoCliente();
...
public class AlumnoCliente {
    ...
    private static final String BASE_URI = "http://localhost:8080/WebAlumnosRest/webresources";

    public AlumnoCliente() {
        com.sun.jersey.api.client.config.ClientConfig config = new com.sun.jersey.api.client.config.DefaultClientConfig();
        client = Client.create(config);
        webResource = client.resource(BASE_URI).path("modelo.tbalumno");
    }

    public <T> T findByApellidos(Class<T> responseType, String apellidos) throws UniformInterfaceException {
        WebResource resource = webResource;
        resource = resource.path(java.text.MessageFormat.format("{0}", new Object[]{apellidos}));
